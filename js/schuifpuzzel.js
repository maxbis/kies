...
function initPuzzle(){
    ...
    createTitle("Klik om te starten");
    buildPieces();
...
function eindTijd () {
    ...
    document.getElementById("resultaat").innerHTML ="Tijd is voorbij."
